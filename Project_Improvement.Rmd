...
lm(log(Overall) ~  Age + log(Crossing)+ log(Finishing)+ log(HeadingAccuracy)+ log(ShortPassing)+ log(Volleys)+ log(Curve)+ log(FKAccuracy)+ log(LongPassing)+
...
lm(log(Overall) ~  Age + log(Crossing)+ log(Finishing)+ log(HeadingAccuracy)+ log(ShortPassing)+ log(Volleys)+ log(Curve)+ log(FKAccuracy)+ log(LongPassing)+
     log(BallControl)+Acceleration+SprintSpeed+Agility+Reactions+Balance+ShotPower+
     Jumping+Stamina+log(LongShots)+Aggression+log(Interceptions)+log(Positioning)+ log(Vision)+ log(Penalties)+
     log(Composure)+log(Marking)+log(StandingTackle)+ log(SlidingTackle), data = data.train)
resettest(lm(log(Overall) ~ Age + log(Crossing)+ log(Finishing)+ log(HeadingAccuracy)+ log(ShortPassing)+ log(Volleys)+ log(Curve)+ log(FKAccuracy)+ log(LongPassing)+
     log(BallControl)+Acceleration+SprintSpeed+Agility+Reactions+Balance+ShotPower+
     Jumping+Stamina+log(LongShots)+Aggression+log(Interceptions)+log(Positioning)+ log(Vision)+ log(Penalties)+
     log(Composure)+log(Marking)+log(StandingTackle)+ log(SlidingTackle), data = data.train))
