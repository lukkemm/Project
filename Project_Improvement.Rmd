...
p3 <- ggplot(data, aes(x = Reactions, y = Overall)) + geom_point()

p4 <- ggplot(data, aes(x = Balance, y = Overall)) + geom_point()

p5 <- ggplot(data, aes(x = ShotPower, y = Overall)) + geom_point()

p6 <- ggplot(data, aes(x = Jumping, y = Overall)) + geom_point()

p7 <- ggplot(data, aes(x = Stamina, y = Overall)) + geom_point()

p8 <- ggplot(data, aes(x = LongShots, y = Overall)) + geom_point()

p9 <- ggplot(data, aes(x = Aggression, y = Overall)) + geom_point()

p10 <- ggplot(data, aes(x = Interceptions, y = Overall)) + geom_point()

p11 <- ggplot(data, aes(x = Positioning, y = Overall)) + geom_point()

p12 <- ggplot(data, aes(x = Vision, y = Overall)) + geom_point()

p13 <- ggplot(data, aes(x = Penalties, y = Overall)) + geom_point()

p14 <- ggplot(data, aes(x = Composure, y = Overall)) + geom_point()

p15 <- ggplot(data, aes(x = Marking, y = Overall)) + geom_point()

p16 <- ggplot(data, aes(x = StandingTackle, y = Overall)) + geom_point()

p17 <- ggplot(data, aes(x = SlidingTackle, y = Overall)) + geom_point()

library(gridExtra)

grid.arrange(p1,p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16,p17, nrow = 6)
```